...
An AI-powered app designed to assist teachers with grading by providing insightful recommendations. I built the backend using Django and integrated it with the React frontend, built by my friend Ksenia. We are developing a **freemium model** that offers a free basic tier for individual educators and a premium version for schools, complete with enhanced features and integrations.
